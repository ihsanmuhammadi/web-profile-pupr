...
<section class="py-3 px-4">
    <div class="container-fluid">
        <div class="align-items-center mb-4 mt-2">
            <h2 class="fw-bold" style="color:#4A7097;">Lamaran</h2>
        </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 rounded-4 shadow-lg">
            <div class="modal-header rounded-top-4" style="background-color: #4A7097;">
                <h5 class="modal-title text-white fw-semibold" id="tambahBannerModalLabel">Tambah Peluang Kerja & Magang</h5>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 shadow-lg">
            <div class="modal-header" style="background-color: #4A7097;">
                <h5 class="modal-title text-white fw-semibold" id="detailModalLabel">Detail Lamaran</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body p-4">
                <div class="row align-items-start p-2">
                    ...
                    <div class="row mb-3 align-items-end">
                        ...
                        <div class="col-md-4">
                            <label class="form-label fw-semibold small text-dark mb-1">Pendidikan</label>
                            <input type="text" class="form-control rounded-3" id="detailPendidikan" value="Lorem ipsum lorem ipsum lorem ipsum" readonly>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-semibold small text-dark mb-1">Jurusan</label>
                            <input type="text" class="form-control rounded-3" id="detailJurusan" value="Lorem ipsum lorem ipsum lorem ipsum" readonly>
                        </div>
                    </div>
                    <div class="mb-3">
...
{{-- <div class="modal fade" id="editBannerModal" tabindex="-1" aria-labelledby="editBannerModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 rounded-4 shadow-lg">
            ...
            <!-- Header -->
            <div class="modal-header rounded-top-4" style="background-color: #4A7097;">
                <h5 class="modal-title text-white fw-semibold" id="editBannerModalLabel">Edit Peluang Kerja & Magang</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
...
<div class="modal fade" id="confirmDeleteModal" tabindex="-1" aria-labelledby="confirmDeleteModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg text-center p-4 mt-5">
            ...
            <h5 class="fw-bold mb-2">Hapus Lamaran?</h5>
            <p class="text-muted small mb-4">Apakah kamu yakin akan menghapus lamaran ini?<br>Aksi ini tidak dapat dibatalkan.</p>
