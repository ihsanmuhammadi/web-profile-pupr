...
<section class="pedoman-content py-5">
  <div class="container col-lg-9 mx-auto">
    ...
    <h2 class="fw-bold mt-5 mb-5 text-center" data-aos="zoom-in">Pedoman Spesifikasi Daerah Dinas PUPR Kubu Raya</h2>
    ...
    <h4 class="fw-semibold mb-1 mt-4">Pedoman Spesifikasi Daerah Dinas PUPR Kubu Raya</h4>
