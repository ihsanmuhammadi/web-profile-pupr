    ...
    <div class="container col-lg-9 mx-auto">
        ...
        <div class="my-5">
            ...
            <p class="text-muted">
                ...
                <a href="#" class="text-success text-decoration-underline fw-medium" data-bs-toggle="modal" data-bs-target="#modalPerumahan">
...
{{-- modal pupup informasi --}}
<div class="modal fade" id="modalPerumahan" tabindex="-1" aria-labelledby="modalPerumahanLabel" aria-hidden="true">
