...
@section('title', 'Jembatan Lingkungan')
...
<section class="py-5 mt-5">
    <div class="container col-lg-9 mx-auto">
        ...
        <div class="my-5">
            <h1 class="fw-bold">Jembatan Lingkungan</h1>
            <p class="text-muted">
                ...
                <a href="#" class="text-success text-decoration-underline fw-medium" data-bs-toggle="modal" data-bs-target="#modalJembatanLingkungan">
...
{{-- modal informasi --}}
<div class="modal fade" id="modalJembatanLingkungan" tabindex="-1" aria-labelledby="modalJembatanLingkunganLabel" aria-hidden="true">
