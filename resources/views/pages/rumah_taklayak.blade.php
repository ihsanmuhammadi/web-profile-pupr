...
@section('title', 'Rumah Tak Layak Huni')
...
<section class="py-5 mt-5">
    <div class="container col-lg-9 mx-auto">
        ...
        <div class="my-5">
            <h1 class="fw-bold">Rumah Tak Layak Huni</h1>
            <p class="text-muted">
                ...
                <a href="#" class="text-success text-decoration-underline fw-medium" data-bs-toggle="modal" data-bs-target="#modalRumahTaklayak">
...
<div class="modal fade" id="modalRumahTaklayak" tabindex="-1" aria-labelledby="modalRumahTaklayakLabel" aria-hidden="true">
