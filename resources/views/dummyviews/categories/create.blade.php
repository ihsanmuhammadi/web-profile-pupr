...
<form action="{{ route('categories.store') }}" method="POST" style="max-width: 500px;">
    ...
    <div style="margin-bottom: 15px;">
        ...
        <textarea name="contoh_program_1" id="contoh_program_1"
                  style="width: 100%; padding: 8px; border: 1px solid #ccc; border-radius: 4px;">{{ old('contoh_program_1') }}</textarea>
    </div>
     ...
     <div style="margin-bottom: 15px;">
        ...
        <textarea name="contoh_program_2" id="contoh_program_2"
                  style="width: 100%; padding: 8px; border: 1px solid #ccc; border-radius: 4px;">{{ old('contoh_program_2') }}</textarea>
    </div>
    ...
    <div style="margin-bottom: 15px;">
        ...
        <textarea name="contoh_program_3" id="contoh_program_3"
                  style="width: 100%; padding: 8px; border: 1px solid #ccc; border-radius: 4px;">{{ old('contoh_program_3') }}</textarea>
    </div>
